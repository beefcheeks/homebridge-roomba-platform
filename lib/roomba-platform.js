...
class RoombaPlatform {
   ...
   async configureBatteryAccessoryServices(accessory, device) {
    ...
    async configureDockAccessoryServices(accessory, device) {
        let dockService = accessory.getServiceByID(
    ...
    async configureFindAccessoryServices(accessory, device) {
        let findService = accessory.getServiceByID(
            this.Service.Switch,
            'Find'
        )
        if (!findService) {
    ...
    async configurePauseAccessoryServices(accessory, device) {
        let pauseService = accessory.getServiceByID(
            this.Service.Switch,
            'Pause'
        )
        if (!pauseService) {
    ...
    async configureReturnAccessoryServices(accessory, device) {
        let returnService = accessory.getServiceByID(
            this.Service.Switch,
            'Return'
        )
        if (!returnService) {
    ...
    async configureStartAccessoryServices(accessory, device) {
        let startService = accessory.getServiceByID(
            this.Service.Switch,
            'Start'
        )
        if (!startService) {
    ...
    async configureStuckAccessoryServices(accessory, device) {
        let stuckService = accessory.getServiceByID(
    ...
    async configureRoomAccessoryServices(accessory, device) {
        ...
        let roomService = accessory.getServiceByID(
            this.Service.Switch,
            name
        )
        if (!roomService) {
