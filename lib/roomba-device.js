...
class RoombaDevice {
    ...
    setStateDetails({batPct, bin, cleanMissionStatus, lastCommand}) {
        ...
        // Save room info if phase is running and there is a mission ID
        if (this.phase === RUNNING && this.missionId) {
            // Reset mapping to prevent unlimited size creep
            this.missionIdMap = {}
            this.missionIdMap[missionId] = {pMapId: pmap_id, regionIds}
        }
